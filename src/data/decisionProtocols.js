    ...
    outcomes: [
      {
        ...
        recommendations: [
          {
            id: 'ap-activate-061-transfer',
            rule: 'HK-AP-TX-001',
            label: 'Activar 061 / traslado urgente',
            detail: 'Solicitar recurso urgente y traslado a Urgencias con ECG, potasio, hora de muestra, funcion renal y medicacion.',
            critical: true,
